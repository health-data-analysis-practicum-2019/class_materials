...
```{r}
#nmes.data<-read.csv("~/Courses/PHBiostats/GoogleDrive/2019_280.347/Module1/nmesUNPROC.csv", stringsAsFactors=FALSE)
#nmes.data<-read.csv("./Module1/nmesUNPROC.csv", stringsAsFactors=FALSE)
library(readr)
nmesUNPROC <- read_csv("Module1/nmesUNPROC.csv")
```
