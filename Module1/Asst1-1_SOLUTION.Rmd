...
Sequence from 4 to 10 with 0.4 between each value.
(Write answer here)
...
Yes, it is case sensitive, so be careful!
...
##### **Exercises 3**
You should create a directory for storing materials from this class, including slides, .Rmd files, and data sets. This way, you will know how to find everything you need for your analysis.
...
table(nmes.data$educate, nmes.data$eversmk, nmes.data$beltuse)
```
