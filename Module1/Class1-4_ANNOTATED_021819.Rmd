...
The effect of smoking on disease risk on the log odds scale is `r format(coefficients(glmOut)[2], digits=3)`. This means the odds ratio comparing non smokers to smokers is `r format(exp(coefficients(glmOut)[2]), digits=3)`. The p-value of the smoking variable is `r format(summary(glmOut)$coefficients["eversmkYes", "Pr(>|z|)"], digits=3)`
