...
head(pred.model2.resp)
head(exp(pred.model2))
head(fitted(glm.model2))
```
...
kable(confint(glm.model2), digits=3)
...
kable(tidy(glm.ns3), caption="Table 1. Natural Splines Model Output", digits=3)
```
...
kable(model_coefs, caption = "Table 2: Beta coefficients across models", digits=5)
...
power_series = function(power,maxN){
  ...
  print(paste("I am running the function on input value ", power))
