...
Markdown cheatsheet for formatting: https://github.com/adam-p/markdown-here/wiki/Markdown-Cheatsheet
...
## Part 6. Weights and weighted average

If you have made it as far as calculating the inverse of the variance, you are almost there! Here is some code (fake) that might help you get the rest of the way.

```{r}
## made up data
means<-c(2,3,4,5)
invVar<-c(0.1, 0.2, 0.3, 0.5)

weights<-invVar/sum(invVar)
weightedAvg<-sum(means*weights)
