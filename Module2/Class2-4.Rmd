...
ny.data <-read.csv("/Users/shannonellis/Google Drive/2018_280.347/Module2/nmmaps/ny.csv", stringsAsFactors=FALSE)
...
getEsts<-function(cityName){
  ...
  currDat<-read.csv(paste0("/Users/shannonellis/Google Drive/2018_280.347/Module2/nmmaps/", cityName, ".csv"), stringsAsFactors=FALSE)
